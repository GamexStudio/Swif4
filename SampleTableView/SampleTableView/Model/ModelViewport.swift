...
public final class ModelViewport: NSCoding {
  ...
  public required init(json: JSON) {
    northeast = ModelNortheast(json: json[SerializationKeys.northeast])
    southwest = ModelSouthwest(json: json[SerializationKeys.southwest])
  }
  ...
  required public init(coder aDecoder: NSCoder) {
    self.northeast = aDecoder.decodeObject(forKey: SerializationKeys.northeast) as? ModelNortheast
    self.southwest = aDecoder.decodeObject(forKey: SerializationKeys.southwest) as? ModelSouthwest
  }
